...
namespace AgVueAutomation.pages
{
    class BASECreditRequest
    {
        ...
        public static string readBreadCrumbs()
        {
            ...
            try
            {
                str = lib.initializeTest.driver.FindElement(By.XPath(".//*[@class='ui-bizagi-form-process-path box-description']/p")).Text;
        ...
        /// Description: Should enter the bewo fields to add a new Applicant
        /// </summary>
        ...
        public static Boolean addApplicant(string customerType, string applicantRole, string applicantType, string firstName, string middleName, string lastName, string suffix, string dob, string maritalStatus, string employer, string taxIdNo, string taxExempt, string conflictOfInterest, string address1, string address2, string city, string state, string zipCode, string zipCodeExt, string popcountyname, string popCountyCode, string emailAddress, string homePhoneCode, string homePhone, string workPhoneCode, string workPhone, string workPhoneExt, string faxCode, string faxNumber, string MobilePhoneCode, string MobilePhone)
        {
            ...
            try
            {
                ...
                if (lib.initializeTest.driver.FindElement(By.XPath("html/body/div[6]")).Displayed)
                {
                    ...
                    string CountyName = lib.initializeTest.driver.FindElement(By.XPath(".//*[@data-render-xpath='sCountyName']/div/div/div/input")).GetAttribute("value");
                    ...
                    string CountyCode = lib.initializeTest.driver.FindElement(By.XPath(".//*[@data-render-xpath='sCountyCode']/div/div/div/input")).GetAttribute("value");
        ...
        /// <returns></returns>
        public static Boolean addLoanActions(string loanOfficer, string loanAssistant, string branch, string loanActionCode, string term, string loanAmount, string loanPurpose)
        {
            Boolean ret = false;
            try
            {
