...
{
    // Florida Credit Requests
    class FCFCreditRequest
    {
        ...
        /// <summary>
        /// Function Name : addResponsiblePartyFlorida
        ...
        /// <returns></returns>
        public static Boolean addResponsiblePartyFlorida(string rpName, string involvementInFarming, string integratorProcessor, string comments, string headquarterState, string headquarterCounty, string firstName, string lastName, string address, string city, string state, string zipCode, string taxNumber, string taxIdType)
        {
            Boolean ret = false;
            try
            {
                ...
                if (involvementInFarming != "")
                {
                    ...
                    lib.initializeTest.driver.FindElement(By.XPath(".//*[@id='911e9273-6715-41e2-958c-50067c9513f6']")).Click();
                    lib.initializeTest.driver.FindElement(By.XPath(".//*[@id='dd-911e9273-6715-41e2-958c-50067c9513f6']/ul/li[text()='" + involvementInFarming + "']")).Click();
        ...
        /// <returns></returns>
        public static Boolean addLoanActionsFlorida(string loanOfficer, string loanAssistant, string branch, string loanActionCode, string term, string loanAmount, string loanPurpose)
        {
            Boolean ret = false;
            try
            {
                ...
                if (loanOfficer != "")
                {
                    ...
                    lib.resultUtil.AddResult("Select Loan Officer", "Should select <<" + loanOfficer + ">> for Loan Officer", "Selected <<" + loanOfficer + ">> for Loan Officer", "PASS");
                }
                //Select Loan Assistant
                if (loanAssistant != "")
                {
                    lib.initializeTest.driver.FindElement(By.XPath(".//label[text()='Loan Assistant']//..//..//following-sibling::div//input[@class='ui-select-data ui-selectmenu-value']")).Click();
                    lib.initializeTest.driver.FindElement(By.XPath(".//label[text()='Loan Assistant']/../../div/div[@class='ui-select-dropdown open']/ul/li[text()='" + loanAssistant + "']")).Click();
                    lib.resultUtil.AddResult("Select Loan Assistant", "Should select <<" + loanAssistant + ">> for Loan Assistant", "Selected <<" + loanAssistant + ">> for Loan Assistant", "PASS");
                }
                //Select Branch
                if (branch != "")
                {
        ...
        /// <summary>
        /// Function Name : addinquiryDecisionFlorida
        ...
        public static Boolean addinquiryDecisionFlorida(string inquiryDecision, string appCurrentDate, string inquiryComments)
        {
            Boolean ret = false;
            try
            {
        ...
        /// <summary>
        /// Function Name : addCollateralandApplicationFlorida
        ...
        /// <returns></returns>
        public static Boolean addCollateralandApplicationFlorida(string appDecision, string appComments)
        {
            Boolean ret = false;
        ...
        /// <summary>
        /// Function Name : EditLoanActionFlorida
        ...
        /// <summary>
        /// Function Name : addLoanActiondetailsFlorida
        ...
        public static Boolean addLoanActiondetailsFlorida(string underwritingType, string approvalAuthority, string lenderDecision)
        {
            Boolean ret = false;
            try
            {
        ...
        public static Boolean assignAnalystFlorida(string creditAnalyst)
        {
            Boolean ret = false;
            try
            {
                // Select 'Review Required' as No
                lib.initializeTest.driver.FindElement(By.XPath(".//*[@data-render-xpath='PRC_ACR_CreditRequest.entCreditAnalysis.bReviewRequired']/div/div/div[1]/div[3]/div[2]/label[contains(text(),'No')]")).Click();
                lib.resultUtil.AddResult("Select << Review Required >> as No", "Should select << Review Required >> as No", "Selected << Review Required >> as No", "PASS");
        ...
        /// <summary>
        /// Function Name : acceptAnalysisFlorida
        /// Description : Accept credit request
        /// </summary>
        /// <param name="acceptanceComments"></param>
        /// <returns></returns>

        //Select Accepted for acceptance decision and submit
        public static Boolean acceptAnalysisFlorida(string acceptanceComments)
        {
            Boolean ret = false;
            try
            {
        ...
        /// <summary>
        /// Function Name : creditAnalysisFlorida
        ...
        public static void creditAnalysisFlorida(string assignedPD, string assignedLGD, string analysisStartedDt)
        {
            try
            {
                ...
                // Select the Final CDA / Loan Narrative has been Uploaded to DocHub Check box
        ...
        /// <summary>
        /// Function Name : preDecisionReviewFlorida
        /// Description : Should select approval authority and send for decisioning
        /// </summary>
        /// <param name="approver"></param>
        /// <returns></returns>
        public static void preDecisionReviewFlorida(string approver)
        {
            try
            {
                ...
                if (lib.initializeTest.driver.FindElement(By.XPath(".//*[@class='ui-dialog-title' and text()='Add Approvers for Credit Request']")).Displayed)
                {
                    ...
                    if (approver != "")
                    {
                        lib.initializeTest.driver.FindElement(By.XPath(".//*[@id='68b06521-26b7-4d10-afc9-fa3e466b1504']")).Click();
                        lib.initializeTest.driver.FindElement(By.XPath(".//*[@id='dd-68b06521-26b7-4d10-afc9-fa3e466b1504']/ul/li[text()='" + approver + "']")).Click();
        ...
        /// Description : Select Loan Action Closing Checkbox and click reassign button
        /// </summary>
        public static void clickLoanActionClosing()
        {
            ...
            {
                //Select checkbox
                lib.initializeTest.driver.FindElement(By.XPath(".//input[@name='workItemAdmin'][contains(@value,'Accept Loan Action Closing')]")).Click();
                lib.resultUtil.AddResult("Select Loan Action Closing checkbox", "Should select Loan Action Closing checkbox", "Successfully selected Loan Action Closing checkbox", "PASS");
        ...
        //Select Print Documents Checkbox and click reassign button
        public static void printDocscheck()
        {
            try
            {
                //Select Print Documents checkbox
                lib.initializeTest.driver.FindElement(By.XPath(".//input[@name='workItemAdmin'][contains(@value,'Print Documents')]")).Click();
                lib.resultUtil.AddResult("Select Loan Action Closing checkbox", "Should select Loan Action Closing checkbox", "Successfully selected Loan Action Closing checkbox", "PASS");
        ...
        //Select Final credit request actions Checkbox and click reassign button
        public static void finCredchk()
        {
            try
            {
        ...
        //Select Received Signed docs and send for booking Checkbox and click reassign button
        public static void recSigndocsbk()
        {
            try
            {
                //Select checkbox
                lib.initializeTest.driver.FindElement(By.XPath(".//input[@name='workItemAdmin'][contains(@value,'Receive Signed Docs and Send for Booking')]")).Click();
                lib.resultUtil.AddResult("Select Loan Action Closing checkbox", "Should select Loan Action Closing checkbox", "Successfully selected Loan Action Closing checkbox", "PASS");
        ...
        //Select Postclose task Checkbox and click reassign button
        public static void postClosechk()
        {
            try
            {
                //Select checkbox
        ...
        //Fetch loan action closing from right pane
        public static void fetchtask()
        {
            try
            {
                ...
                //Click on the Approve Loan Action Closing
                lib.initializeTest.driver.FindElement(By.XPath(".//li[@class='event']/a/span[text()='Accept Loan Action Closing']")).Click();
                lib.resultUtil.AddResult("Click on the Approve Loan Action Closing task", "Should Click on the Approve Loan Action Closing task", "Clicked on the Approve Loan Action Closing task", "PASS");
                System.Threading.Thread.Sleep(3000);
            }
            catch (Exception e)
            {
        ...
        /// <summary>
        /// Function Name : acptlnactions
        /// Description : Acceptloan actions after selecting the mandatory values
        /// </summary>
        ...
        /// <returns></returns>
        public static void acptlnactions(string cdProcLo, string cdRecServLo, string cdMLO, string docReviewDecision)
        {
            try
            {
               //Click on the Accept loan actions Button
                lib.initializeTest.driver.FindElement(By.XPath(".//input[@id='formButton0']")).Click();
                lib.resultUtil.AddResult("Click On Accept loan actions Button", "Should click On Accept loan actions Button", "Clicked On Accept loan actions Button", "PASS");
                System.Threading.Thread.Sleep(3000);
                ...
                // Scroll Into View
                IWebElement elem2 = lib.initializeTest.driver.FindElement(By.XPath(".//label[text()='Loan Action Comments']"));
                ...
                // Select the Verified Delegated Authority Check box
                lib.initializeTest.driver.FindElement(By.XPath(".//div[@data-render-xpath='ACR_M_LoanAction.entLoanActionClosing.bVerifyDelegatedAuthority']/div/div/div/label/input")).Click();
                lib.resultUtil.AddResult("Select the Verified Delegated Authority Check box", "Should Select the Verified Delegated Authority Check box", "Selected the Verified Delegated Authority Check box", "PASS");

                // Select the Documents Prepared Check box
                lib.initializeTest.driver.FindElement(By.XPath(".//div[@data-render-xpath='ACR_M_LoanAction.entLoanActionClosing.bDocumentsPrepared']/div/div/div/label/input")).Click();
                lib.resultUtil.AddResult("Select the Documents Prepared Check box", "Should Select the Documents Prepared Check box", "Selected the Documents Prepared Check box", "PASS");
                ...
                // Select the Closing Checklist Tab
                lib.initializeTest.driver.FindElement(By.XPath(".//*[@title='Closing Checklist']")).Click();
                ...
                lib.initializeTest.driver.FindElement(By.XPath(".//div[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div[2]/div/table/tbody[@class='ui-bizagi-grid-body']/tr[1]/td[3]/div/div/span/span/span/div/label[contains(text(),'Complete')]")).Click();
                ...
                lib.initializeTest.driver.FindElement(By.XPath(".//div[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div[2]/div/table/tbody[@class='ui-bizagi-grid-body']/tr[2]/td[3]/div/div/span/span/span/div/label[contains(text(),'Complete')]")).Click();
                ...
                // Select the 'Complete' option for Consumer Loan Pre-Close Task
                lib.initializeTest.driver.FindElement(By.XPath(".//div[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div[2]/div/table/tbody[@class='ui-bizagi-grid-body']/tr[3]/td[3]/div/div/span/span/span/div/label[contains(text(),'Complete')]")).Click();
                lib.resultUtil.AddResult("Select << Complete >> option for the Consumer Loan Pre-Close Task", "Should select << Complete >> option for the Consumer Loan Pre-Close Task", "Selected << Complete >> option for Consumer Loan Pre-Close Task", "PASS");

                // Select the 'Complete' option for Loan to New Member Pre-Close Task
                lib.initializeTest.driver.FindElement(By.XPath(".//div[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div[2]/div/table/tbody[@class='ui-bizagi-grid-body']/tr[4]/td[3]/div/div/span/span/span/div/label[contains(text(),'Complete')]")).Click();
                lib.resultUtil.AddResult("Select << Complete >> option for the Loan to New Member Pre-Close Task", "Should select << Complete >> option for the Loan to New Member Pre-Close Task", "Selected << Complete >> option for Loan to New Member Pre-Close Task", "PASS");
        ...
        // Select documents printed checkbox and pre-close status as complete
        public static void printDocuments()
        {
            try
            {
                // Select the Documents Printed Check box
                lib.initializeTest.driver.FindElement(By.XPath(".//div[@data-render-xpath='ACR_M_LoanAction.entLoanActionClosing.bDocumentsPrinted']/div/div/div/label/input")).Click();
                lib.resultUtil.AddResult("Select the << Documents Printed >> Check box", "Should Select the << Documents Printed >> Check box", "Selected the Documents Printed Check box", "PASS");

                // Select the 'Complete' option for Applicant Pre-Close Task1
                lib.initializeTest.driver.FindElement(By.XPath(".//*[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div[2]/div[1]/table/tbody/tr[1]/td[4]/div/div/span/label/input")).Click();
                lib.resultUtil.AddResult("Select << Complete >> option for the Applicant Pre-Close Task1", "Should select << Complete >> option for the Applicant Pre-Close Task1", "Selected << Complete >> option for Applicant Pre-Close Task1", "PASS");

                // Select the 'Complete' option for Applicant Pre-Close Task2
                lib.initializeTest.driver.FindElement(By.XPath(".//*[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div[2]/div[1]/table/tbody/tr[2]/td[4]/div/div/span/label/input")).Click();
                lib.resultUtil.AddResult("Select << Complete >> option for the Applicant Pre-Close Task2", "Should select << Complete >> option for the Applicant Pre-Close Task2", "Selected << Complete >> option for Applicant Pre-Close Task2", "PASS");
                ...
                // Select the 'Complete' option for Consumer Loan Pre-Close Task
                lib.initializeTest.driver.FindElement(By.XPath(".//*[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div[2]/div[1]/table/tbody/tr[3]/td[4]/div/div/span/label/input")).Click();
                lib.resultUtil.AddResult("Select << Complete >> option for the Consumer Loan Pre-Close Task", "Should select << Complete >> option for the Consumer Loan Pre-Close Task", "Selected << Complete >> option for Consumer Loan Pre-Close Task", "PASS");

                // Select the 'Complete' option for Loan to New Member Pre-Close Task
                lib.initializeTest.driver.FindElement(By.XPath(".//*[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div[2]/div[1]/table/tbody/tr[4]/td[4]/div/div/span/label/input")).Click();
                lib.resultUtil.AddResult("Select << Complete >> option for the Loan to New Member Pre-Close Task", "Should select << Complete >> option for the Loan to New Member Pre-Close Task", "Selected << Complete >> option for Loan to New Member Pre-Close Task", "PASS");
        ...
        /// Description : Received signed docs and sent for booking
        /// </summary>
        public static void receSignedDocs(string lnClosedDate)
        {
            try
            {
                // Select the Received Signed Documents and Sent for Booking Check box
                ...
                //Enter Loan Closed Date
                lib.initializeTest.driver.FindElement(By.XPath(".//div[@data-render-xpath='ACR_M_LoanAction.entLoanActionClosing.dLoanClosedDate']/div/div/div/div/span/input")).Clear();
                lib.initializeTest.driver.FindElement(By.XPath(".//div[@data-render-xpath='ACR_M_LoanAction.entLoanActionClosing.dLoanClosedDate']/div/div/div/div/span/input")).SendKeys(lnClosedDate);
                lib.resultUtil.AddResult("Enter Application Date", "Should enter Valid Application Date", "Entered <<" + lnClosedDate + ">> for Application Date", "PASS");


                // Select the 'Received' option for Applicant Pre-Close Task1
                //lib.initializeTest.driver.FindElement(By.XPath(".//*[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div/div/div/div/div[2]/div/table/tbody[@class='ui-bizagi-grid-body']/tr[1]/td[4]/div/div/span/label/input")).Click();
                lib.initializeTest.driver.FindElement(By.XPath(".//div[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div[2]/div/table/tbody/tr[1]/td[5]/div/div/span/label/input")).Click();
                lib.resultUtil.AddResult("Select << Complete >> option for the Applicant Pre-Close Task1", "Should select << Complete >> option for the Applicant Pre-Close Task1", "Selected << Complete >> option for Applicant Pre-Close Task1", "PASS");
                ...
                // Select the 'Received' option for Applicant Pre-Close Task2
                //lib.initializeTest.driver.FindElement(By.XPath(".//*[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div/div/div/div/div[2]/div/table/tbody[@class='ui-bizagi-grid-body']/tr[2]/td[4]/div/div/span/label/input")).Click();
                //lib.resultUtil.AddResult("Select << Complete >> option for the Applicant Pre-Close Task2", "Should select << Complete >> option for the Applicant Pre-Close Task2", "Selected << Complete >> option for Applicant Pre-Close Task2", "PASS");
                lib.initializeTest.driver.FindElement(By.XPath(".//div[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div[2]/div/table/tbody/tr[2]/td[5]/div/div/span/label/input")).Click();

                // Select the 'Received' option for Consumer Loan Pre-Close Task
                //lib.initializeTest.driver.FindElement(By.XPath(".//*[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div/div/div/div/div[2]/div/table/tbody[@class='ui-bizagi-grid-body']/tr[3]/td[4]/div/div/span/label/input")).Click();
                //lib.resultUtil.AddResult("Select << Complete >> option for the Consumer Loan Pre-Close Task", "Should select << Complete >> option for the Consumer Loan Pre-Close Task", "Selected << Complete >> option for Consumer Loan Pre-Close Task", "PASS");
                lib.initializeTest.driver.FindElement(By.XPath(".//div[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div[2]/div/table/tbody/tr[3]/td[5]/div/div/span/label/input")).Click();

                // Select the 'Received' option for Loan to New Member Pre-Close Task
                //lib.initializeTest.driver.FindElement(By.XPath(".//*[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div/div/div/div/div[2]/div/table/tbody[@class='ui-bizagi-grid-body']/tr[4]/td[4]/div/div/span/label/input")).Click();
                //lib.resultUtil.AddResult("Select << Complete >> option for the Loan to New Member Pre-Close Task", "Should select << Complete >> option for the Loan to New Member Pre-Close Task", "Selected << Complete >> option for Loan to New Member Pre-Close Task", "PASS");
                lib.initializeTest.driver.FindElement(By.XPath(".//div[@id='ACR_M_LoanAction_colPreCloseChecklistItems']/div/div[2]/div/table/tbody/tr[4]/td[5]/div/div/span/label/input")).Click();
        ...
        /// <summary>
        /// Function Name : reviewedAndBooked
        /// Description : Select the Loan booked and Funded Check box and submit
        /// </summary>

        public static void reviewedAndBooked()
        {
            try
            {
                System.Threading.Thread.Sleep(5000);
        ...
        /// <summary>
        /// Function Name : postCloseTasks
        /// Description : Florida - Select complete status as Post close tasks
        /// </summary>


        public static void postCloseTasks()
        {
            try
            {
                ...
                // Select the Independent Verification Complete Check box
                lib.initializeTest.driver.FindElement(By.XPath(".//div[@data-render-xpath='ACR_M_LoanAction.entLoanActionClosing.bIndependentVerified']/div/div/div/label/input")).Click();
                lib.resultUtil.AddResult("Select the << Independent Verification Complete >> Check box", "Should Select the << Independent Verification Complete >> Check box", "Selected the Independent Verification Complete Check box", "PASS");
        ...
        /// Description : Select the All AgVUE Documents have been uploaded to DocHub Check box and select manadatory fields to submit
        /// </summary>
        public static void finalCreditRequestActions()
        {
            try
            {
                ...
                IWebElement elem = lib.initializeTest.driver.FindElement(By.XPath(".//span[text()='Loan Action Checklist']"));
                IJavaScriptExecutor js = (IJavaScriptExecutor)lib.initializeTest.driver;
                js.ExecuteScript("arguments[0].scrollIntoView(true);", elem);
                
                //Click on the edit Link to Edit Loan Action Checklist
